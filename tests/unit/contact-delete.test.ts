...
import { contactDeleteAction } from '../../src/commands/contact/delete.js';
...
describe('contactDeleteAction', () => {
  ...
  it('deletes a user contact successfully', async () => {
    ...
    await contactDeleteAction.call(ctx as any, '@alice');
  ...
  it('rejects channel entity with NOT_A_USER', async () => {
    ...
    const ctx = createMockCommandContext();
    await contactDeleteAction.call(ctx as any, '@somechannel');
